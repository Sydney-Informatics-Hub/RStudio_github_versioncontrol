...
-   `File > New Project > Version Control > Git`. <br>In "Repository URL", paste the URL of your new GitHub repository. It will be something like this `https://github.com/Sydney-Informatics-Hub/myrepo_masterclass_RStudio_github.git`.
